  ...
  static tokenMissing(): NotionCLIError {
    return new NotionCLIError(
      ...
      [
        {
          description:
            "Set your Notion integration token using the config command",
  ...
  static tokenInvalid(): NotionCLIError {
    return new NotionCLIError(
      ...
      [
        ...
        {
          description:
            "Check if the integration has been removed or revoked by workspace admin",
        },
      ],
    ...
    return new NotionCLIError(
      ...
      isId
        ? [
            ...
            {
              description:
                "The integration may not have access - share the resource with your integration",
            },
            {
        ...
        : [
            ...
            {
              description:
                "List all available databases to find the correct name",
  ...
  static invalidIdFormat(
    ...
    return new NotionCLIError(
      ...
      [
        {
          description:
            "Notion IDs are 32 hexadecimal characters (with or without dashes)",
        },
        {
  ...
  static databaseIdConfusion(attemptedId: string): NotionCLIError {
    return new NotionCLIError(
      ...
      [
        {
          description:
            "This CLI automatically handles the conversion - you can use either",
        },
        {
          description:
            "If you copied this from Notion API docs, the ID itself is still valid",
        },
        {
          description:
  ...
  static workspaceNotSynced(databaseName: string): NotionCLIError {
    return new NotionCLIError(
      ...
      [
        {
          description:
            "Run sync to index all accessible databases in your workspace",
          command: "notion-cli sync",
        },
        {
          description:
            "After syncing, list all databases to verify it was found",
          command: "notion-cli list",
        },
        {
          description:
            "If sync doesn't find it, the integration may not have access",
        },
        {
          description:
            "Try using the database ID or URL directly instead of name",
  ...
  static invalidJson(jsonString: string, parseError: Error): NotionCLIError {
    return new NotionCLIError(
      ...
      [
        {
          description:
            "Check for common JSON syntax errors: missing quotes, trailing commas, unclosed brackets",
        },
        {
        ...
        {
          description:
            "For filters, you can use a filter file instead of inline JSON",
  ...
  static invalidProperty(
    ...
    return new NotionCLIError(
      ...
      [
        {
          description:
            "Get the database schema to see all available properties",
          command: databaseId
  ...
  static networkError(originalError: Error): NotionCLIError {
    return new NotionCLIError(
      ...
      [
        ...
        {
          description:
            "The CLI will automatically retry transient network errors",
        },
        {
 ...
 */
export function wrapNotionError(
  error: any,
  context: ErrorContext = {},
): NotionCLIError {
    ...
    switch (error.code) {
      ...
      case "object_not_found":
        ...
        if (
          ...
          ["database", "page", "block"].includes(context.resourceType)
        ) {
    ...
    [
      {
        ...
        link: "https://github.com/infograb/notion-cli/issues",
      },
    ],
    { ...context, originalError: error },
  );
...
export function handleCliError(
  ...
  const cliError =
    error instanceof NotionCLIError ? error : wrapNotionError(error, context);
