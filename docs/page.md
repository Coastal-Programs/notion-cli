...
```
USAGE
  $ notion-cli page create [-p <value>] [-d <value>] [-f <value>] [-t <value>] [--properties <value>] [-r]
...
```
USAGE
  $ notion-cli page retrieve PAGE_ID [--map | -r | [-m | -c | -P]] [--columns <value> |
...
## `notion-cli page property-item PAGE_ID PROPERTY_ID`

Retrieve a page property item

```
USAGE
  $ notion-cli page property-item PAGE_ID PROPERTY_ID [-r] [-j] [--page-size <value>] [--retry] [--timeout <value>]
    [--no-cache] [-v] [--minimal]
...
EXAMPLES
  ...
  Retrieve a page property item and output raw json
    ...
    $ notion-cli page property-item PAGE_ID PROPERTY_ID -r

  Retrieve a page property item and output JSON for automation

    $ notion-cli page property-item PAGE_ID PROPERTY_ID --json
```
...
```
USAGE
  $ notion-cli page update PAGE_ID [-a] [-u] [--properties <value>] [-r] [--columns <value> | -x] [--sort
